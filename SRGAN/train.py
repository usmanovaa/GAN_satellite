...
if __name__ == '__main__':
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        netG.eval()
        out_path = path+ 'training_results/' + DATASET_NAME + '/' 'SRF_' + str(UPSCALE_FACTOR) + '/'
        ...
        out_path_model = path+  'epochs/' + DATASET_NAME + '/'
        ...
        if epoch >= 0:
            out_path_stat = path+ 'statistics/' + DATASET_NAME + '/' 'SRF_' + str(UPSCALE_FACTOR) + '/'
            # check path exist 
            ...
            data_frame.to_csv(out_path_stat + 'srf_' + str(UPSCALE_FACTOR) + '_train_results.csv', index_label='Epoch')
